...
本目录收录企业 AI、AI 原生组织、Forward Deployed Engineer（FDE）以及相关公司方法论的研究整理。
...
1. **调查数据**：来自公开调研，注明样本、时间和口径。
2. **公司披露**：来自企业官网、招聘信息或案例，属于公司自述，不能等同于独立验证。
3. **分析判断**：基于前两类信息的推断，会明确标注为分析或建议。
